		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#seidorinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"seidorinvoices-display": {
								"semanticObject": "seidorinvoices",
								"action": "display",
								"description": "Inovices List",
								"title": "Invoices List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=seidor.invoices",
									"url": sap.ui.require.toUrl("seidor/invoices")
								}
							}
						}
					}
